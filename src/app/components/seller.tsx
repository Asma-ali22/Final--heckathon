              ...
              return(
                <div className="container mx-auto px-28 py-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {seller.map((seller) => (
                      <div key={seller.id} className="bg-white shadow-md rounded-md p-4">
                        ...
                        <h3 className="text-lg font-medium mt-4">{seller.title}</h3>
                        <p className="text-gray-500">{seller.department}</p>
                        <div className="flex justify-between items-center mt-2">
                          <span className="text-red-500 line-through">{seller.price}</span>
                          <span className="text-green-500 font-bold">{seller.discount}</span>
                        </div>
                      </div>
                    ))}
                  </div>
