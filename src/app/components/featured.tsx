        ...
        const posts = [
          {
            ...
            date: "27 April 2024",
            imgSrc: "/fi.jpeg", // Replace with your image paths
          },
          {
            id: 2,
            title: "Loudest à la Madison #1 (L'intégral)",
            description: "Problems of importance and meaning trying to resolve the conflict.",
            date: "27 April 2024",
            imgSrc: "/f2.jpeg", // Replace with your image paths
          },
          {
            id: 3,
            title: "Loudest à la Madison #1 (L'intégral)",
            description: "Problems of importance and meaning trying to resolve the conflict.",
            date: "27 April 2024",
            imgSrc: "/f3.jpeg", // Replace with your image paths
          },
        ];
        const Featured=()=>{
        return (
          <div className="px-6 py-10 bg-gray-50 mt-9 mr-20 ml-20">
